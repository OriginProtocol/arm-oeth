...
contract Fork_Concrete_LidoARM_Setters_Test_ is Fork_Shared_Test_ {
    ...
    function test_SetPrices_Operator() public asOperator {
        ...
        lidoARM.setPrices(address(steth), 9980e32, 99998e32, type(uint128).max, type(uint128).max);
        // 2% of one basis point spread
        lidoARM.setPrices(address(steth), 999999e30, 1000001e30, type(uint128).max, type(uint128).max);

        lidoARM.setPrices(address(steth), 992 * 1e33, 1001 * 1e33, type(uint128).max, type(uint128).max);
        lidoARM.setPrices(address(steth), 99999e31, 1004 * 1e33, type(uint128).max, type(uint128).max);
