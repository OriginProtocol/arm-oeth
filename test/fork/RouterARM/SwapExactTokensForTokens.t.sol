...
contract Fork_Concrete_ARMRouter_SwapExactTokensForTokens_Test_ is Fork_Shared_ARMRouter_Test {
    ...
    ////////////////////////////////////////////////////
    ///    Revert Tests - SwapExactTokensForTokens
    ////////////////////////////////////////////////////
    function test_Revert_When_SwapExactTokensForTokens_Because_Insufficient_Output() public {
    ...
    function test_Revert_When_SwapExactTokensForTokens_Because_Expired() public {
    ...
    function test_Revert_When_SwapExactTokensForTokens_Because_Wrap_Failed() public {
    ...
    function test_Revert_When_SwapExactTokensForTokens_Because_PathNotFound() public {
    ...
    ////////////////////////////////////////////////////
    ///    Revert Tests - SwapExactETHForTokens
    ////////////////////////////////////////////////////

    function test_Revert_When_SwapExactETHForTokens_Because_InvalidPath() public {
    ...
    function test_Revert_When_SwapExactETHForTokens_Because_Insufficient_Output() public {
        // Swap eth to eeth with high min amount out
        uint256 amountIn = 10 ether;
        address[] memory path = new address[](2);
        path[0] = address(weth);
        path[1] = address(eeth);
        ...
        vm.expectRevert("ARMRouter: INSUFFICIENT_OUTPUT");
        router.swapExactETHForTokens{value: amountIn}(12 ether, path, address(this), block.timestamp + 1);
    }

    ////////////////////////////////////////////////////
    ///    Revert Tests - SwapExactTokensForETH
    ////////////////////////////////////////////////////

    function test_Revert_When_SwapExactTokensForETH_Because_InvalidPath() public {
    ...
    function test_Revert_When_SwapExactTokensForETH_Because_Insufficient_Output() public {
        // Swap eeth to eth with high min amount out
        uint256 amountIn = 10 ether;
        address[] memory path = new address[](2);
        path[0] = address(eeth);
        path[1] = address(weth);
        ...
        vm.expectRevert("ARMRouter: INSUFFICIENT_OUTPUT");
        router.swapExactTokensForETH(amountIn, 12 ether, path, address(this), block.timestamp + 1);
    }
}
