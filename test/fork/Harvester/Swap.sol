...
contract Fork_Concrete_Harvester_Swap_Test_ is Fork_Shared_Test {
    ...
    function test_RevertWhen_Swap_Because_InvalidSwapRecipient() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Harvester.InvalidSwapRecipient.selector, deployer), address(harvester));
        vm.prank(governor);
    ...
    function test_RevertWhen_Swap_Because_InvalidFromAsset() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Harvester.InvalidFromAsset.selector, address(os)), address(harvester));
        vm.prank(governor);
        harvester.swap(Harvester.SwapPlatform.Magpie, address(ws), 1e18, data);
    }
    ...
    function test_RevertWhen_Swap_Because_InvalidToAsset() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Harvester.InvalidToAsset.selector, Sonic.SILO), address(harvester));
        vm.prank(governor);
        harvester.swap(Harvester.SwapPlatform.Magpie, address(os), 1e18, data);
    }
    ...
    function test_RevertWhen_Swap_Because_InvalidFromAssetAmount() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Harvester.InvalidFromAssetAmount.selector, 1 ether), address(harvester));
        vm.prank(governor);
        harvester.swap(Harvester.SwapPlatform.Magpie, address(os), 2e18, data);
    }
    ...
    function test_RevertWhen_Swap_Because_SlippageError() public {
        ...
        vm.expectPartialRevert(Harvester.SlippageError.selector);
        vm.prank(governor);
        harvester.swap(Harvester.SwapPlatform.Magpie, address(os), 1e18, data);
    }
